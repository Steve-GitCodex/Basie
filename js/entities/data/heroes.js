...
export const HEROES_CONFIG = {
  warlord: {
    ...
    skills: ['commanding_presence', 'battle_cry', 'iron_will', 'charge', 'rally', 'last_stand'],
  ...
  archsorceress: {
    ...
    skills: ['arcane_archive', 'arcane_nova', 'mana_shield', 'fireball', 'mana_surge', 'cataclysm'],
  ...
  paladin: {
    ...
    skills: ['bulwark', 'holy_light', 'consecration', 'divine_shield', 'second_wind', 'aegis_of_the_faithful'],
  ...
  junovane: {
    ...
    skills: ['signal_boost', 'field_repairs', 'spliced_optics', 'emp_burst', 'overclock', 'static_ward'],
  ...
  kaelenthorne: {
    ...
    skills: ['scavenge', 'trail_marks', 'grit', 'cache_run', 'safe_route', 'wastelands_bounty'],
    aura: { type: 'gold_production', value: 0.15, buffCategory: 'production' },
    xpPerLevel: 500,
  ...
  shadowblade: {
    ...
    skills: ['killers_instinct', 'poison_blade', 'evasion', 'shadowstep', 'throat_cut', 'no_witnesses'],
